...
export class ProductDetailsComponent implements OnInit {
  ...
  products: IProduct[] = [
    {
      ...
      "stock": 5,
      "reviews": [
        { "rating": 2, "comment": "Very unhappy!", "date": "2024-05-23", "reviewerName": "John Doe", "reviewerEmail": "john.doe@x.dummyjson.com" },
        { "rating": 5, "comment": "Very satisfied!", "date": "2024-05-23", "reviewerName": "Scarlett Wright", "reviewerEmail": "scarlett.wright@x.dummyjson.com" }
      ],
  ...
  productDetails: IProduct | undefined; // Allow undefined

  ngOnInit() {
    this.productDetails = this.products.find(
      (product: IProduct) => product.id === Number(this.id)
    ) || this.products[0]; // Fallback to first product if undefined
  }
}
